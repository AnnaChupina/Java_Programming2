...
public class MultiDimensionalArrayPractice2 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arr3D.length; i++) {   // i: index of each 2 dimensional arrays
            int[][] each2DSArray = arr3D[i];
            System.out.println(Arrays.deepToString(each2DSArray));
            for (int j = 0; j < each2DSArray.length; j++) {  // j: index of each 1 dimensional array
              int [] each1DArray = each2DSArray[j];
