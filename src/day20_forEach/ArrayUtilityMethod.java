...
public class ArrayUtilityMethod {
    public static void main(String[] args) {
        ...
        Arrays.sort(nums);
        System.out.println("After the sorting: " +Arrays.toString( nums));
        ...
        String[] students = {"Yaxier", "Madiyar", "Ali", "Abdullah", "Alena"};
        ...
        char[] result2 = Arrays.copyOfRange(ch,2,4);  // excluding ending index
