...
public abstract class Car {   // mean to bo inherited, can not be instantiated
    ...
    public Car(String model, String color, int year, double price) {
        this.make = getClass().getSimpleName();  // to set the class nameto the make of the car
        this.model = model;
        setColor(color);
        if (year < 1886) {
    ...
    protected abstract void start();   //  mean to be overriden
