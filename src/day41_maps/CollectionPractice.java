...
public class CollectionPractice {
    ...
    public static void main(String[] args) {
       ...
       // Iterator<Integer> it = new
        ...
        listOfSets.get(0).addAll(Arrays.asList(10, 5, 10, 20, 5, 20));
        listOfSets.get(1).addAll(Arrays.asList(30, 15, 350));
        listOfSets.get(2).addAll(Arrays.asList(1300, 4515, 20));
        listOfSets.get(3).addAll(Arrays.asList(130, 15, 205));
    ...
    //    System.out.println(listOfArrays);
        ...
        // how to update 3th element to 35
